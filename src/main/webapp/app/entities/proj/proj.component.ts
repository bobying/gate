...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/proj'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: Proj) {
        return item.id;
    }
    ...
    registerChangeInProjs() {
        this.eventSubscriber = this.eventManager.subscribe('projListModification', (response) => this.loadAll());
    }
